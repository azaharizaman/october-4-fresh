...
/**
 * CreateMriReturnsTable Migration
 *
...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('omsb_inventory_mri_returns', function(Blueprint $table) {
            $table->engine = 'InnoDB';
            ...
            // Foreign key - Original MRI being returned
            ...
            // Foreign key - Warehouse (where items are being returned to)
            ...
            // Indexes
            $table->index('document_number', 'idx_mri_returns_doc_number');
            $table->index('return_date', 'idx_mri_returns_date');
            $table->index('status', 'idx_mri_returns_status');
            $table->index(['requestor_id', 'return_date'], 'idx_mri_returns_requestor_date');
            $table->index('deleted_at', 'idx_mri_returns_deleted_at');
        });
    }
    ...
    {
        Schema::dropIfExists('omsb_inventory_mri_returns');
    }
};
